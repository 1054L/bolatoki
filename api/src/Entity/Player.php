...
#[ApiFilter(SearchFilter::class, properties: ['name' => 'partial', 'surname' => 'partial', 'province' => 'partial', 'club.name' => 'partial', 'gender' => 'exact'])]
#[ApiFilter(BooleanFilter::class, properties: ['federated'])]
#[ApiFilter(OrderFilter::class, properties: ['id', 'name', 'surname'])]
...
class Player
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['game:read', 'championship:read', 'player:read'])]
    private ?int $id = null;

    #[ORM\Column(length: 255)]
    #[Groups(['game:read', 'championship:read', 'player:read', 'player:write'])]
