...
final class Version20241230110129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, birthdate DATE DEFAULT NULL, category VARCHAR(255) NOT NULL, gender SMALLINT NOT NULL, province VARCHAR(255) DEFAULT NULL, club_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_98197A6561190A32 (club_id), UNIQUE INDEX UNIQ_98197A65A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
